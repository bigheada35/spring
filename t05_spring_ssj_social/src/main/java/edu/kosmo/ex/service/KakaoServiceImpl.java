...
public class KakaoServiceImpl {
	 ...
	 //ssj private final static String K_CLIENT_ID = "d367f2f3dacfeafe2113e96d64623b88";
	 //private final static String K_CLIENT_ID = "7df15154cd15e7e3fefcfd0b7d57931d";//ssj javaScript키
	 private final static String K_CLIENT_ID = "7f25d3ad61d6e9a8a3f5d097ab7ae9ae";//ssj REST API 키
	 
	 private final static String K_REDIRECT_URI = "http://localhost:8282/ex/auth/kakao/callback";
	 //temp private final static String K_REDIRECT_URI = "http://localhost:8282/ex/";//ssj
	 

	public String getAuthorizationUrl() {
		System.out.println("-------getKakaoTokenInfo 0-------");
	...
	public KakaoAuth getKakaoTokenInfo(String code) {
		System.out.println("-------getKakaoTokenInfo 1-------");
		...
		System.out.println("-------getKakaoTokenInfo 2-------");
		// Set http entity
		HttpEntity<MultiValueMap<String, String>> kakaoTokenRequest = new HttpEntity<>(params, headers);

		// 실제로 요청하기
		// Http 요청하기 - POST 방식으로 - 그리고 response 변수의 응답을 받음.
		System.out.println("-------getKakaoTokenInfo 3-------");
