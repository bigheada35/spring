...
<body>
   ...
   <table width="500" cellpadding="0" cellspacing="0" border="1">
      <form:form action="nmodify_view" method="post">
         ...
         <tr>
            <td> 작성자 </td>
            <td> ${content_view.member_number} </td>
         ...
         <tr>
          ...
          <tr>
            ...
            <a href="nlist">목록보기</a> &nbsp;&nbsp; 
            <%-- <a href="nmodify?board_id=${content_view.board_id}">수정하기</a> &nbsp;&nbsp; --%> 
            
            <a href="nmodify_view?board_id=${content_view.board_id}">수정하기</a> &nbsp;&nbsp;
            
            <%-- <a href="modify_view?board_id=${content_view.board_id}">수정하기</a> &nbsp;&nbsp; --%>
