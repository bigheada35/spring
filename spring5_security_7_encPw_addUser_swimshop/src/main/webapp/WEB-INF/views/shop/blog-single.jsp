...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="${pageContext.request.contextPath}/resources/eshopper/js/html5shiv.js"></script>
    <script src="${pageContext.request.contextPath}/resources/eshopper/js/respond.min.js"></script>
    <![endif]-->       
						...
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<sec:authorize access="isAuthenticated()">
									<li><a href=""><i class="fa fa-user"></i><sec:authentication property="name" /> </a></li>
								</sec:authorize>
				...
				<div class="col-sm-9">
					<div class="blog-post-area">
						...
						<div class="single-blog-post">
							...
							<a href="">
								<img src="${pageContext.request.contextPath}/resources/eshopper/images/blog/blog-one.jpg" alt="">
							</a>
							<p>
					...
					<div class="socials-share">
						<a href=""><img src="${pageContext.request.contextPath}/resources/eshopper/images/blog/socials.png" alt=""></a>
					</div><!--/socials-share-->

					<div class="media commnets">
						<a class="pull-left" href="#">
							<img class="media-object" src="${pageContext.request.contextPath}/resources/eshopper/images/blog/man-one.jpg" alt="">
						</a>
					...
					<div class="response-area">
						...
						<ul class="media-list">
							<li class="media">
								...
								<a class="pull-left" href="#">
									<img class="media-object" src="${pageContext.request.contextPath}/resources/eshopper/images/blog/man-two.jpg" alt="">
								</a>
								<div class="media-body">
							...
							<li class="media second-media">
								<a class="pull-left" href="#">
									<img class="media-object" src="${pageContext.request.contextPath}/resources/eshopper/images/blog/man-three.jpg" alt="">
								</a>
								<div class="media-body">
									<ul class="sinlge-post-meta">
										<li><i class="fa fa-user"></i>Janis Gallagher</li>
							...
							<li class="media">
								<a class="pull-left" href="#">
									<img class="media-object" src="${pageContext.request.contextPath}/resources/eshopper/images/blog/man-four.jpg" alt="">
								</a>
								<div class="media-body">
									<ul class="sinlge-post-meta">
										<li><i class="fa fa-user"></i>Janis Gallagher</li>
