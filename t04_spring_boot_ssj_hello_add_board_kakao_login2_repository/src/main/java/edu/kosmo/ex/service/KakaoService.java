...
import edu.kosmo.ex.domain.User;
import edu.kosmo.ex.domain.UserRole;
import edu.kosmo.ex.repository.UserRepository;
...
public class KakaoService {
    ...
    //public KakaoService(UserRepository userRepository, PasswordEncoder passwordEncoder, KakaoOAuth2 kakaoOAuth2, AuthenticationManager authenticationManager) {
     public KakaoService(UserRepository userRepository, KakaoOAuth2 kakaoOAuth2) {    	
    //public KakaoService(KakaoOAuth2 kakaoOAuth2) {    	
        this.userRepository = userRepository;
        //this.passwordEncoder = passwordEncoder;
        this.kakaoOAuth2 = kakaoOAuth2;
        //this.authenticationManager = authenticationManager;
        System.out.println("---===============KakaoService construct=======================-");
    }
    ...
    public String kakaoLogin(String token) {
        ...
        //ssj String password = kakaoId + ADMIN_TOKEN;
        String password = kakaoId + "12345";//ssj
        ...
        if (kakaoUser == null) {
            // 패스워드 인코딩
        	//ssj  String encodedPassword = passwordEncoder.encode(password);
        	String encodedPassword = password;//ssj
            // ROLE = 사용자
        ...
        //ssj
        	...
        	System.out.println("-----중복된 Kakao Id 가 있음----");
        }
